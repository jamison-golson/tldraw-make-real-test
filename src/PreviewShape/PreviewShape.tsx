...
export class PreviewShapeUtil extends BaseBoxShapeUtil<PreviewShape> {
	...
	//Figure out what canUnmount does
	...
	override toSvg(shape: PreviewShape, ctx: SvgExportContext): ReactElement | null | Promise<ReactElement | null>{
		...
		return new Promise((resolve, _) => {
			...
			const windowListener = (event: MessageEvent) => {
				if (event.data.screenshot && event.data?.shapeid === shape.id) {
					...
					// resolve(g)
					// Resolve with a React component containing the SVG
					resolve(
						<svg width={shape.props.w} height={shape.props.h} dangerouslySetInnerHTML={{ __html: g.outerHTML }} />
					);
				}
			}
